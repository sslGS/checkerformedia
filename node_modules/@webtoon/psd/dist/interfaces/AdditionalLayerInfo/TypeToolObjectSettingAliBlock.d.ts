 ...
 */
export interface TypeToolObjectSettingAliBlock extends KnownAliBlock<AliKey.TypeToolObjectSetting> {
    version: 1;
    transformXX: number;
    transformXY: number;
    transformYX: number;
...
//# sourceMappingURL=TypeToolObjectSettingAliBlock.d.ts.map