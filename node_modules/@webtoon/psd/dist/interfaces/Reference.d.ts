 ...
 * @see Descriptor
 */
export type Reference = ClassReference | EnumeratedReference | IdentifierReference | IndexReference | NameReference | OffsetReference | PropertyReference;
...
export interface EnumeratedReference extends ReferenceBase<ReferenceType.Enumerated> {
    name: string;
    classId: string;
    typeId: string;
    enumValue: string;
}
export interface IdentifierReference extends ReferenceBase<ReferenceType.Identifier> {
    identifier: string;
}
...
export interface PropertyReference extends ReferenceBase<ReferenceType.Property> {
    name: string;
    classId: string;
    keyId: string;
}
