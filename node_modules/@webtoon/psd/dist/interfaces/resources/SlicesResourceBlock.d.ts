...
export type SlicesResourceBlock = ImageResourceBlockBase<ResourceType.Slices, SlicesResourceBlockV6 | SliceResourceBlockV7>;
 ...
 * @alpha
 */
export declare enum SliceOrigin {
    /**
...
export declare function matchSliceOrigin(origin: number): SliceOrigin;
interface SliceResourceBlockV7 {
    version: 7 | 8;
    descriptor: VersionedDescriptor;
}
export {};
//# sourceMappingURL=SlicesResourceBlock.d.ts.map